 ...
 */
const W1H2Panel = ({ title, children, headerRight, className = '' }) => {
    return (
        <div className={`col-span-1 row-span-2 bg-white rounded-lg shadow-lg flex flex-col ${className}`}>
