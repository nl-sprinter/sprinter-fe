...
/**
 * Issue 리스트 컨테이너
 * @param {array} issues - Issue 목록
 * @param {function} onAddIssue - Issue 추가 함수
 * @param {function} onRemoveIssue - Issue 삭제 함수
 * @param {function} onIssueResolution - Issue 해결 상태 변경 함수
 * @param {function} onEditIssue - Issue 수정 함수
 */
const BacklogIssueContainer = ({
    issues = [],
    onAddIssue,
    onRemoveIssue,
    onIssueResolution,
